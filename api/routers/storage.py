"""Storage routes: disk usage, runtime settings, cleanup, protected source deletion."""
...
from api.routers._models import StorageSettingsModel
...
@router.get("/api/storage", tags=["storage"])
def storage_status() -> dict:
    return _storage_state()


@router.post("/api/storage/settings", tags=["storage"])
...
@router.post("/api/storage/cleanup", tags=["storage"])
...
@router.delete("/api/jobs/{job_id}/source", tags=["storage"])
