"""Clip downloads: the metadata-bundled zip, and the bare video file."""
...
#: Every route below carries the ``clips`` tag, supplied here rather
...
@router.get("/api/clips/{job_id}/{filename}/download")
...
@router.get("/api/clips/{job_id}/{filename}/video")
