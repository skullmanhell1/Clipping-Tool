...
def st_font_availability(
    ...
    *,
    ...
    availability.update({f"font:{family}": bool(flag) for family, flag in zip(ladder, flags)})

    available_families = tuple(family for family, flag in zip(ladder, flags) if flag)
