...
def _preset_strategy():
    ...
    return st.builds(
        lambda base, animation, font, font_size, position, hi, scale, emoji, border, primary, highlight, outline, box: (
            CaptionPreset(
                name=base.name,
                animation=animation,
                font=font,
                ...
                colors=CaptionColors(
                    primary=primary, highlight=highlight, outline=outline, box=box
                ),
                position=position,
