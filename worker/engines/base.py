...
if TYPE_CHECKING:
    ...
    #
    # These two names were previously bare string annotations carrying an F821 suppression, which
...
class Engine_Context:
    ...
    def rng(self) -> random.Random:
        ...
        """
        # Engine determinism is a documented requirement, not a weak secret.
