...
class Capability_Kind(StrEnum):
    """Probeable capability kinds (Req 5.1); mirrors the StrEnum style of ``Engine_Stage``."""
...
def default_prober(capability_id: str) -> Capability_Status:
    ...
    except BaseException as exc:  # noqa: BLE001 - totality is the contract (Req 5.3)
...
class Capability_Report:
    ...
    def _probe(self, capability_id: str) -> Capability_Status:
        ...
        except BaseException as exc:  # noqa: BLE001 - Req 5.3
            if isinstance(exc, (KeyboardInterrupt, SystemExit)):
                raise
