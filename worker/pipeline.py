...
def run_pipeline(
    ...
    for idx, c in enumerate(candidates):
        ...
        # Both marker groups go here, after `merge_markers`, which rebinds `applied` — appending
        # before it would drop them on every clip, and a missing degradation marker is invisible
        # in a render that otherwise succeeds.
